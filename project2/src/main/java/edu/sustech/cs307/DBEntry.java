            ...
            while (running) {
                try {
                    ...
                    if (sql.equalsIgnoreCase("exit")) {
                        ...
                        printHelp();
                        continue;
                    } else if (sql.equalsIgnoreCase("SET enable_indexscan = off;")) {
                        Logger.info("enable_indexscan off");
                        dbManager.en_index(false);
                        continue;
                    }else if(sql.equalsIgnoreCase("SET enable_indexscan = on;")){
                        Logger.info("enable_indexscan on");
                        dbManager.en_index(true);
                        continue;
                    }
                } catch (Exception e) {
                    Logger.error(e.getMessage());
